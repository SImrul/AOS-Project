...
do
  ...
  hadoop jar /home/idcuser/WordCount.jar org.apache.hadoop.examples.WordCount /user/idcuser/cs5531/inputTC1/testinput2.dat /user/idcuser/cs5531/output/output$(date +%Y%m%d%H%M%S%N) 20 ${reducesarray[i]} ${priorityarray[i]} &
done

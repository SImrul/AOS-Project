...
do
  ...
  hadoop jar /home/idcuser/WordCount.jar org.apache.hadoop.examples.WordCount /user/idcuser/cs5531/input/testinput1.dat /user/idcuser/cs5531/output/output$(date +%Y%m%d%H%M%S%N) ${mapsarray[i]} ${reducesarray[i]} ${priorityarray[i]} &
done
